...
你面临裁员，不知道如何主张自己的权利？<br>
你担心被企业过分压榨，不知道如何谈判？<br>
你需要心理支持，不知道如何度过这段艰难时期？<br>
你需要法律知识，不知道如何保护自己的合法权益？<br>

**让被裁员.skill 成为你的权益保护助手，为你提供专业的法律建议和谈判策略！**

**希望每一位被裁员的员工，都能被温柔以待。裁员不可怕，只是下一段人生的开始。**
...
上传你的个人信息（也可以无中生友，上传你一个朋友的个人信息）和相关证据（工作邮件、飞书/钉钉聊天记录、合同等），生成一个**个性化的被裁员应对 AI Skill**，帮助你计算赔偿、制定谈判策略、提供心理支持、准备法律文件。
...
> **注意**：本项目基于同事.skill 项目修改，专为面临裁员的员工提供权益保护和心理支持。


## 支持的数据来源

> 目前还是被裁员.skill 的 alpha 测试版本，后续会有更多来源支持，请多多关注！
...
按提示输入姓名、工作基本信息（公司、入职时间、职级、年薪、绩效情况）、个人状态（年龄、学历、婚姻状况、子女情况、父母情况、房贷情况）、裁员情况（当前阶段和诉求）、个人状态标签，然后选择数据来源。所有字段均可跳过，仅凭描述也能生成。
...
> 输入：`张三, 阿里巴巴 2020-01-01 13 60万/年 325，32 硕士 已婚 1个 有（月供8000元），正在谈判 2N赔偿，有子女 有房贷 焦虑不安 据理力争 中风险`
...
运行逻辑：`接到任务 → 个人画像判断需求和心理状态 → 权益保护能力提供具体方案 → 考虑用户的沟通风格和风险承受能力输出`
...
- 建议优先收集：与 HR/管理层的聊天记录、劳动合同、工资条、社保记录等
